...
Usage:
    python3 bantuvoice/eval/wer/fleurs.py \\
...
# bantuvoice/__init__.py heavy imports.
if "bantuvoice" not in sys.modules:
...
from bantuvoice.eval.wer.common import log_metrics, process_one
from bantuvoice.eval.wer.text_norm_omni import text_normalize
...
# fix mismatched language codes between BantuVoice and Omnilingual-ASR model
rename = {
    "et": "ekk",
    "ms": "zsm",
    "sw": "swh",
