...
This directory contains scripts and configs for training, fine-tuning, and evaluating BantuVoice.
...
NUM_GPUS=2
OUTPUT_DIR="exp/bantuvoice_finetune"      # output directory
```
